...
%
%               Revision-1/18/2024: Sam Jaeger
%                   Error in converting to US units for pressure.
%                   Documentation for US units are wrong.
%               
...
%               Z:          Total Reporting Altitudes[0<=alt<=1000 km][km]{1000*ft}
%               Z_L:        Lower Atmosphere Reporting Altitudes[0<=alt<=86 km][km]{1000*ft}
%               Z_U:        Upper Atmosphere Reporting Altitudes[86<=alt<=1000 km][km]{1000*ft}
%               T:          Temperature array[0<=alt<=1000 km][K]{R}
%               P:          Pressure array[0<=alt<=1000 km][Pa]{psi}
...
P_L = atmo_p(Z_L);
if alt > 86
    P_U = atmo_p(Z_U(end),T_U(end),n_sum);
else
    P_U = [];
end
